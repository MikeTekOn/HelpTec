...
import com.opensoftware.helptec.controller.AdicionarFuncionarioController;
import com.opensoftware.helptec.domain.Especialidade;
import com.opensoftware.helptec.util.ConvertTypeData;
...
public class AdicionarFuncionario extends javax.swing.JFrame {
    ...
    private final AdicionarFuncionarioController contr;
    ...
    public AdicionarFuncionario() {
        initComponents();
        contr = new AdicionarFuncionarioController();
    ...
    private void initComponents() {
        ...
        listaEspecialidade.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        jScrollPane1.setViewportView(listaEspecialidade);
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtDataNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                        .addComponent(jLabel5)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtTlf, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(124, 124, 124)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (Especialidade especialidade : contr.showListEspecialidade()) {
            listModel.addElement(especialidade.especialidade().toString());
        }

        listaEspecialidade.setModel(listModel);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            int tlf = ConvertTypeData.convertToInt(txtTlf.getText());
            Especialidade esp = contr.showListEspecialidade().get(listaEspecialidade.getSelectedIndex());

            
            contr.adicionarNovoFuncionario(esp, nome, morada, data, tlf);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdicionarFuncionario().setVisible(false);
            }
        });
    }
